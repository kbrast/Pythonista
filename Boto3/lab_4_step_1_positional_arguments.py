...
def main():
    translate_text('I am learning to code using Python in AWS Boto3','en','fr') # we provide the value for the arguments when we call the function in the correct positional order.
